...
class Expression:
    def __init__(self, expr_string, variables):
        ...
        self.length = len(self.expr_string)
    ...
    def parse_np(self, expression, variables):
        a = expression.split()
        if a[0] != '-' and a[0] != '+':
            a = ['+'] + a
        ...
        for k in range(len(a)):
                        ...
                        if idx != len(indices) - 1:
                            ...
                            if next_index != len(temp):
                                if varIndex + 1 != next_index:
                                    powers.append(self.num_parse(temp[varIndex + 2:next_index]))
                                else:
                                    powers.append(1.0)
                            else:
                                if varIndex != len(temp) - 1:
                                    powers.append(self.num_parse(temp[varIndex + 2: len(temp)]))
                                else:
                                    powers.append(1.0)
                        else:
                            if varIndex != len(temp) - 1:
            ...
            coefficient = self.num_parse(coefficient)
